...
│   │   ├── manage.tsx          ← مدیریت ۷ تب CRUD + تب برچسب‌ها
│   │   └── settings.tsx        ← تنظیمات: تم، پین، سینک، پیامک، هوش مصنوعی، ربات، یادآور بومی
│   └── lib/
...
| **مدیریت** | ۷ تب CRUD واقعی: حساب، دسته با آیکون، تگ، بودجه، هدف، تراکنش دوره‌ای و روش پرداخت + داده نمونه/پاک‌سازی؛ موجودیت‌های انتقال، چک، اشتراک، دارایی و ارز در مدل داده، داشبورد و خروجی گزارش پشتیبانی می‌شوند اما تب CRUD مستقل ندارند |
| **تنظیمات** | تم روشن/تیره و ۷ تم رنگی، پین و قفل فوری، سینک ابری + تست اتصال/سینک دستی، بخش «پیامک‌ها» با فهرست کامل پیامک‌های اسکن‌شده، فیلتر بازهٔ شمسی، وضعیت ثبت و حذف محدود به پیامک‌های ثبت‌شده، پیامک بانکی اندروید (فعال‌سازی، اسکن تاریخچه و صف بررسی)، یادآور بومی، هوش مصنوعی، ربات تلگرام، پشتیبان/بازیابی، انتقال بین مرورگر، فهرست کاربران و حذف حساب |
...
- [x] **پیش‌پرکردن و رهگیری پیامک بانکی:** لمس پیامک، فرم تراکنش را با مبلغ تومانی، تاریخ و نوع پر می‌کند؛ پس از ثبت، پیامک با وضعیت «ثبت شد» نگه‌داری می‌شود و در داشبورد و بخش پیامک‌های تنظیمات قابل مشاهده است
